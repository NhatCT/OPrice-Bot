...
const StarterPromptCard: React.FC<{
    ...
    <button
        onClick={onClick}
        className="text-left p-4 bg-white/50 dark:bg-slate-800/50 rounded-xl hover:bg-white dark:hover:bg-slate-800 border border-slate-200/80 dark:border-slate-700/50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-blue-500/30 group"
    >
        <div className="flex items-center space-x-3">
            <div className="flex-shrink-0 w-8 h-8 flex items-center justify-center text-slate-500 dark:text-slate-400 group-hover:text-blue-500 transition-colors duration-300">{icon}</div>
        ...
        <div className="flex-1 flex flex-col justify-center items-center p-6 overflow-y-auto relative">
            ...
            <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <StarterPromptCard
                    ...
                    description="Tính giá bán, doanh số, lợi nhuận và so sánh với đối thủ."
